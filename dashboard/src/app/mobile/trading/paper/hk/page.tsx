...
import { PaperDetailClient } from "../a/PaperDetailClient";

export const dynamic = "force-dynamic";
export const revalidate = 15;

export default function PaperHkDetailPage() {
  const positions = getPaperPortfolio("hk") as any[];
  const nav = getPaperNav("hk", 60);
  const trades = getPaperTrades("hk", 30);
